...
- item: 深淵書架を GitHub の非公開リポジトリへ。持ち主のPCで go-online.sh を走らせる。
  due: 2026-09-08
  default: 待ちを消す。道具は残るのでいつでも実行できる。
...
- item: research.html / research2.html の見出しが `サンプル調査タイトル` のまま。
  due: 2026-09-08
  default: sed で見出しだけ差し替える。research は `調査メモ 1` `2`、
      research2 は `Antigravity 導入メモ 1` `2`。全文は読まない（R-005）。
